...
using SecondHandMarket.DAL.Models;

namespace SecondHandMarket.BLL.Services
{
    public class AuthService : IAuthService
    {
        ...
        private string GenerateJwtToken(User user)
        {
            ...
            var issuer = jwtSettings["Issuer"] ?? "SecondHandMarketAuthApi";
            var audience = jwtSettings["Audience"] ?? "SecondHandMarketUsers";
